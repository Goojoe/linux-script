...
# https://ghproxy.com/github.com/XTLS/Xray-install

# The URL of the script is:
# https://raw.githubusercontent.com/XTLS/Xray-install/main/install-release.sh

# If the script executes incorrectly, go to:
# https://ghproxy.com/github.com/XTLS/Xray-install/issues
...
get_latest_version() {
  ...
  if [[ -z "$RELEASE_LATEST" ]]; then
    if grep -q "API rate limit exceeded" "$tmp_file"; then
      ...
      echo "Welcome bug report:https://ghproxy.com/github.com/XTLS/Xray-install/issues"
    fi
    "rm" "$tmp_file"
    exit 1
  fi
  ...
  do
    ...
    grep -q "https://ghproxy.com/github.com/XTLS/Xray-core/releases/download/${releases_list[$i]}/Xray-linux-$MACHINE.zip" "$tmp_file" && break
  done
  "rm" "$tmp_file"
...
download_xray() {
  DOWNLOAD_LINK="https://ghproxy.com/github.com/XTLS/Xray-core/releases/download/$INSTALL_VERSION/Xray-linux-$MACHINE.zip"
...
Documentation=https://ghproxy.com/github.com/xtls
...
install_geodata() {
  ...
  local download_link_geoip="https://ghproxy.com/github.com/v2fly/geoip/releases/latest/download/geoip.dat"
  local download_link_geosite="https://ghproxy.com/github.com/v2fly/domain-list-community/releases/latest/download/dlc.dat"
